...
export default function RemindersPage() {
    ...
    try {
      await apiFetch('/reminders', {
        ...
        body: JSON.stringify({
          ...
          dueDate, // HTML date input devuelve 'YYYY-MM-DD', perfecto para el backend
        }),
      });
  ...
  // Separamos los pendientes de los ya pagados
  ...
  return (
    <div className="p-6 pb-24 flex flex-col gap-8">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-5 rounded-2xl shadow-sm border border-pink-100">
      ...
      <div className="flex flex-col gap-3">
        ...
        {pendingReminders.length === 0 ? (
          ...
          pendingReminders.map(r => (
            <div key={r.id} className="p-4 bg-white rounded-2xl shadow-sm border-l-4 border-l-[#F9A8D4] border-y border-r border-gray-100 flex items-center justify-between">
      ...
      {/* 3. HISTORIAL DE PAGADOS (Opcional visualmente) */}
